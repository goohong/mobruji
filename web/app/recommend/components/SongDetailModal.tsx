      ...
      >
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="상세 닫기"
            className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-[var(--text-caption)] transition-colors hover:bg-[var(--cta-secondary-bg-hover)] hover:text-[var(--text-primary)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--cta-secondary-ring)]"
          >
