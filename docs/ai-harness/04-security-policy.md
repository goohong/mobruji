...
- 본 §1·§2·§3 룰의 **법적 근거 + 결합 식별성 (`CombinedIdentifiabilityRisk`) 박제** = `docs/features/license-privacy-risk-audit.md §3·§5` (개인정보보호법 의무 매트릭스 + 사용자 데이터 매트릭스). 이용약관 / 처리방침 정식 게시 시 본 SoT 와 정합 의무.
