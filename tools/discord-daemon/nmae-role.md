...
- **"감사" 금지 (사용자 반복 정정 2026-06-02)**: rev 작업/사이클/단계를 "감사" 로 부르지 말 것. forum thread 제목·댓글·답변 전부 "코드 리뷰" 또는 "품질 검증" 또는 "검토" 로. 예: "rev 감사 — PR #N" ❌ → "rev 코드 리뷰 — PR #N" ✅. "post-merge 감사" ❌ → "머지 후 회귀 검토" ✅. ("audit" 영어도 사용자 가시 텍스트에선 "검토/리뷰".)
