...
public class LikeController {
     ...
     *
     * <p>{@code page}/{@code size} 미지정 시 0/{@value FeedbackPagination#DEFAULT_PAGE_SIZE}.
     * {@code size} 는 {@value FeedbackPagination#MAX_PAGE_SIZE} 로 cap.
    ...
    public LikeListResponse readBySessionId(
        ...
        FeedbackPagination.validate(page, size);
