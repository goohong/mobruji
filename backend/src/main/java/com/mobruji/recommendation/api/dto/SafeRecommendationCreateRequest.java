...
import com.mobruji.recommendation.application.SafeRecommendationCommand;
...
/**
 * 안전곡형(P-E) 추천 생성 요청 DTO (persona-expansion-social-emotional.md §5-4).
 *
 * <p>{@code voiceRangeLow}/{@code voiceRangeHigh}는 사용자 음역대(필수). 단일 추천과 같은 음역 적합도 산식을 재사용한다.
 *
 ...
 */
public record SafeRecommendationCreateRequest(
    ...
    public SafeRecommendationCommand toCommand() {
        return new SafeRecommendationCommand(sessionId, voiceRangeLow, voiceRangeHigh, ageGroup, gender, limit);
    }
}
